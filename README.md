# Emprest Trajano - Landing Page

Landing page de empréstimo migrada de HTML/CSS estático para Next.js com integração de Meta Ads e rastreamento de WhatsApp.

## Funcionalidades

- ✅ Seleção de cidades com validação de cobertura
- ✅ Integração Meta Ads Pixel (ID: 1013145803462320)
